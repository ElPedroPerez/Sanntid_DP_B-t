...
#define ACCEL_X_MIN ((float) -308)
#define ACCEL_X_MAX ((float) 324)
#define ACCEL_Y_MIN ((float) -315)
#define ACCEL_Y_MAX ((float) 303)
...
const float magn_ellipsoid_center[3] = {104.539, -45.3166, -53.23};
const float magn_ellipsoid_transform[3][3] = {{0.911727, 0.00478869, -0.00679876}, {0.00478869, 0.928213, -0.000945670}, {-0.00679876, -0.000945670, 0.99452}};

// Gyroscope
// "gyro x,y,z (current/average) = .../OFFSET_X  .../OFFSET_Y  .../OFFSET_Z
#define GYRO_AVERAGE_OFFSET_X ((float) -24.06)
#define GYRO_AVERAGE_OFFSET_Y ((float) -33.84)
#define GYRO_AVERAGE_OFFSET_Z ((float) 19.59)
